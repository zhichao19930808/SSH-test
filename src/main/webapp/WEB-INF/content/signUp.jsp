...
<div class="am-g tpl-g">
    ...
    <div class="tpl-login">
        <div class="tpl-login-content">
            ...
            <form class="am-form tpl-form-line-form" action="<%=request.getContextPath()%>\user!signUp.html">
                ...
                <div class="am-form-group">
                    <input type="text" class="tpl-form-input" placeholder="用户名" name="name">
                </div>
                ...
                <div class="am-form-group">
                    <input type="text" class="tpl-form-input" placeholder="请输入验证码" name="cc" >
